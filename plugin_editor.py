...
class EditModWindow(bui.Window):
    ...
    def __init__(
        ...
        self._theme = babase.app.config.get('Plugin Editor Theme', 'default')
        ...
        self._widgets = []
        self._selected_line_widget: bui.Widget | None = None
        self._saving = False
        self._shown = False
        self._plug_path = babase.env()['python_directory_user']
...
class PluginEditorSettingsWindow(popup.PopupWindow):
    def __init__(self, origin_widget):
        ...
        popup.PopupMenu(
            ...
            current_choice=babase.app.config.get('Plugin Editor Theme', 'default'),
            on_value_change_call=self._set_theme,
        )

    def _set_theme(self, val: str) -> None:
        if babase.app.config.get('Plugin Editor Theme', 'default') != val:
            cfg = bui.app.config
