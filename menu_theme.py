...
import _babaseuiv1 as _bui
import _babasescenev1 as bs
import _babasebase as _ba

import babase as ba
import bascenev1 as bs as bs
import bauiv1 as bui as bui
...
if TARGET_BALLISTICA_BUILD < 21282:
    ...
    babase.app.env.build_number = babase.app.env.engine_build_number
    babase.app.env.device_name = babase.app.env.device_name
    babase.app.env.config_file_path = babase.app.env.config_file_path
    babase.app.env.version = babase.app.env.engine_version
    babase.app.env.debug = babase.app.env.debug
    babase.app.env.test = babase.app.env.test
    babase.app.env.data_directory = babase.app.env.data_directory
    babase.app.env.python_directory_user = babase.app.env.python_directory_user
    babase.app.env.python_directory_app = babase.app.env.python_directory_app
    babase.app.env.python_directory_app_site = babase.app.env.python_directory_app_site
    babase.app.env.api_version = babase.app.env.api_version
    babase.app.env.tv = babase.app.env.tv
    babase.app.env.vr = babase.app.env.vr
    babase.app.env.arcade = babase.app.env.arcade
    babase.app.env.headless = babase.app.env.arcade
    babase.app.env.demo = babase.app.env.demo
...
class MenuThemeWindow:
    ...
    def popup_fileselector(self):
        self._file_selector = FileSelectorWindow(
            path=str(_babase.env()['python_directory_user']),
    ...
    def _export(self, window: FreeEditWindow, txt: Any):
        path = _babase.env()['python_directory_user'] + "/_menutheme/"
        try:
            a = _babase.env()['python_directory_user'] + "/_menutheme"
